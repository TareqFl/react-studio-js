...
| `removeTrackFromDb`       | `track`                         | Event listener for track removed`track`                                                                                                                                                                             |
| `saveTracksToLocalStorage`| `track`                         | Event listener for track update `track`                                                                                                                                                                             |
| `saveToLocalFromSplit`    | `track`                         | Event listener for track update on split `track`                                                                                                                                                                    |
...
| `audiorequeststatechange` | `state, src`                    | Loading audio `src` (`string` or `File`) is now in state (Number)   UNINITIALIZED = 0,
LOADING = 1,
DECODING = 2,
FINISHED = 3,                                                                                                                                                                                                                                                                       |
