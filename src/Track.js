  ...
  */
          ...
          h("label.stereopan", [
            h("input.stereopan-slider", {
              attributes: {
                ...
                max: 100,
                value: 100,
                class:'MuiSlider-root MuiSlider-colorPrimary MuiSlider-sizeMedium css-exkjcx'
              },
  ...
  render(data) {
    ...
    if (data.controls.show) {
      ...
      channelChildren.push(h("span", {
        attributes: {
          style: `position: absolute; color: white; background: #2499EF; z-index: 999; padding: 5px 10px; border-radius: 18px; margin-top: 8px; margin-left: 10px; opacity: 0.8;`,
        },
      },[this.name]))
